...
--
-- grant read on directory tmp_dir to bancos_bdd@kfgbdd_s1;
--
-- 3. Suponer que se desea guardar un archivo en la siguiente tabla:
--
-- create table blob_carga(
--     id number(2,0) ,
--     pdf blob
--  );
--
...
-- Ejemplo:
--
-- insert into blob_carga(id,pdf) values(1, empty_blob());
--
...
--
-- exec  carga_blob_en_bd('TMP_DIR','revista.pdf','blob_carga','pdf','id','1',null,null);
--
...
--
--select  dbms_lob.getlength(pdf) longitud from blob_carga where id = 1;
--
